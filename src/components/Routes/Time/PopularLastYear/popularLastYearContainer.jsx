import PopularLastYear from './popularLastYear.jsx'
...
const PopularLastYearContainer = connect(mapStateToProps, mapDispatchToProps)(PopularLastYear)
export default PopularLastYearContainer