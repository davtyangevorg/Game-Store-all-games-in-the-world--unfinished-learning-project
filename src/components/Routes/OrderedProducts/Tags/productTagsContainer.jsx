...
import {getProductsByBrowseTagsThunkCreator, getAgainProductsThunkCreator, clearStateActionCreator} from '../../../../redux/section-reduser.js'
import {getBrowseInfoThunkCreator,clearBrowseStateActionCreator} from '../../../../redux/browse-reduser.js'

class ProductTagsApi extends React.Component{
    
    componentDidMount=()=>{
        console.log('mount')
        console.log(this.props.match)
        this.props.getBrowseInfo('tags',getParamsId(this.props.match.params.tags))
    }
    componentDidUpdate=()=>{
       console.log('ubdate')
    }
...
const mapDispatchToProps=(dispatch)=>{
    return{
        getProducts:(order,platform,id)=>{
            dispatch(getProductsByBrowseTagsThunkCreator(order,platform,id))
        },
...
const ProductTagsContainer=connect(mapStateToProps,mapDispatchToProps)(ProductTagsApi)
